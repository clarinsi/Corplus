...
export default function ParagraphSourceTab({ data, sentenceId, keyword, keywordErrId }: TabProps) {
    ...
    const generateWord = (w: Pick<WordInsert, "id" | "ana" | "text" | "lemma">) => {
        ...
        const isLemma =
            isHighlighted(w, keyword, "ORIG") || (wordErrorGroup && wordErrorGroup.groupId === keywordErrorGroup);
        ...
        <div className="px-4 flex gap-4 justify-between">
            <div className="flex flex-col gap-4 grow">
                <div className="bg-surface-static-secondary rounded-md p-4">
                    ...
                    <span className="caption text-light-grey">{tParagraph("orig")}</span>
                </div>
                ...
                <div className="flex flex-col">
                    ...
                    {sentence?.words.map((w) => {
                        ...
                        const rowStyle = clsx(
                            ...
                            isHighlighted(w, keyword, "ORIG") && "!font-bold",
                        );
